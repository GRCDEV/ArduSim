...
import static protocols.muscop.pojo.State.*;
...
public class MUSCOPListenerThread extends Thread {
	...
	private Location3DGeo[] shareMission() {
		// The protocols.mission could be sent when  they are in the air, but it is better to do it now
		...
		if (this.isMaster) {
			// 1. Calculus of the protocols.mission for the UAV in the center of the formation
			...
			// 2. Calculate the protocols.mission for the master
			...
			// Store the protocols.mission of the center UAV to allow the talker thread to send it
