...
public class MUSCOPText {
	...
	public static final String MISSION_SELECT = "Flight protocols.mission:";
	...
	public static final String SEND_MISSION = "Sending protocols.mission";	// Blocking slaves until all have the protocols.mission
	...
	public static final String MASTER_DATA_TALKER = "Master talker sending data with protocols.mission.";
