...
public class IncomingMessageQueue {
	 ...
	 * <p>If the queue is full, it ignores the message and return false. */
	 ...
	 * <p>Remember to check if the queue is empty before retrieving the element. */
	public synchronized IncomingMessage peekFirst() {
		return this.queue.peekFirst();
	}
	
	/** Removes and returns the next element in the queue.
	 * <p>Remember to check if the queue is empty before removing the element. */
