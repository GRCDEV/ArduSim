...
public class OLDMBCAPParam {
	...
	public static AtomicReferenceArray<OLDBeacon> selfBeacon;
	// Beacons transmitted by the broker to the CollisionDetector
	public static Map<Long, OLDBeacon>[] beacons;
	...
	public static List<OLDBeacon>[] beaconsStored; // To log the sent beacons
	
	// MBCAP finite state machine states enumerator
	public enum MBCAPState {
		NORMAL((short)1, OLDMBCAPText.STATE_NORMAL),
		STAND_STILL((short)2, OLDMBCAPText.STATE_STAND_STILL),
		MOVING_ASIDE((short)3, OLDMBCAPText.STATE_MOVING_ASIDE),
		GO_ON_PLEASE((short)4, OLDMBCAPText.STATE_GO_ON_PLEASE),
		OVERTAKING((short)5, OLDMBCAPText.STATE_OVERTAKING),
		EMERGENCY_LAND((short)6, OLDMBCAPText.STATE_EMERGENCY_LAND);
