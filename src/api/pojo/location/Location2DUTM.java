...
/** This class generates points in UTM coordinates in meters.
 * <p>Developed by: Francisco Jos&eacute; Fabra Collado, from GRC research group in Universitat Polit&egrave;cnica de Val&egrave;ncia (Valencia, Spain).</p> */

public class Location2DUTM extends Point2D.Double {

	private static final long serialVersionUID = 1L;

	protected Location2DUTM() {
		super();
	}

	/**
	 * Create a location given its UTM coordinates.
	 * @param x (m) Easting.
	 * @param y (m) Northing.
	 */
	public Location2DUTM(double x, double y) {
		super(x, y);
	}
	 ...
	 */
	public Location2DUTM(Location2DUTM location) {
		this.x = location.x;
		this.y = location.y;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj == null || !(obj instanceof Location2DUTM)) {
			return false;
		}
		Location2DUTM location = (Location2DUTM)obj;
	...
	public static Location2DGeo getGeo(double x, double y) throws ArduSimNotReadyException {
		if (SimParam.zone == -1) {
			throw new ArduSimNotReadyException(Text.NOT_READY_EXCEPTION);
		}
