...
public class TakeOffThread extends Thread{
    ...
    private void takeOff(Map<Long, Location2DUTM> UAVsDetected) {
        ...
        // TAKE OFF PHASE
        gui.logUAV(com.protocols.shakeup.pojo.Text.START_TAKE_OFF);
        gui.updateProtocolState(com.protocols.shakeup.pojo.Text.TAKE_OFF);
        ...
        while (CompareTakeOffHelper.isTakeOffFinished.get() != Param.numUAVs) {
