...
public class TopographyDialogController {

    private final ResourceBundle resources;
    private final Stage stage;
    private final TopographySimProperties properties;
    ...
    public TopographyDialogController(ResourceBundle resources, TopographySimProperties properties, Stage stage){
