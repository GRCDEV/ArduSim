...
public class FormationMatrixCompact extends FlightFormation {
	...
	protected void initializeFormation() {
		...
		for (layer = 1; layer <= layers; layer++) {
			...
			point[p] = new FormationPointHelper(distance, layer, 1, validationTools.roundDouble(-layer * this.minDistance, 6), validationTools.roundDouble(layer * this.minDistance, 6));
			p++;
			upRightCorner = new Point2D.Double(layer * this.minDistance, layer * this.minDistance);
			point[p] = new FormationPointHelper(distance, layer, 3, validationTools.roundDouble(upRightCorner.x, 6), validationTools.roundDouble(upRightCorner.y, 6));
			p++;
			...
			p++;
			point[p] = new FormationPointHelper(distance, layer, 6, validationTools.roundDouble(layer * this.minDistance, 6), validationTools.roundDouble(-layer * this.minDistance, 6));
			p++;
			...
			for (int j = 1; j <= sidePoints; j++) {
				...
				point[p] = new FormationPointHelper(distance, layer, 1, validationTools.roundDouble(bottomLeftCorner.x, 6), validationTools.roundDouble(offsetY, 6));
				p++;
			}
			//   right side
			for (int j = 1; j <= sidePoints; j++) {
				...
				point[p] = new FormationPointHelper(distance, layer, 2, validationTools.roundDouble(upRightCorner.x, 6), validationTools.roundDouble(offsetY, 6));
				p++;
			}
			//   up side
			for (int j = 1; j <= sidePoints; j++) {
				...
				point[p] = new FormationPointHelper(distance, layer, 5, validationTools.roundDouble(offsetX, 6), validationTools.roundDouble(upRightCorner.y, 6));
				p++;
			}
			//   bottom side
			for (int j = 1; j <= sidePoints; j++) {
				...
				point[p] = new FormationPointHelper(distance, layer, 6, validationTools.roundDouble(offsetX, 6), validationTools.roundDouble(bottomLeftCorner.y, 6));
				p++;
			}
		}
